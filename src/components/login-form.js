...
const LoginForm = {
  render() {
    return /* html */`
        <!-- LOGIN -->
      <div class="lg:flex my-12 mb-32">
      <div class="lg:w-1/2 xl:max-w-screen-sm">
        <div class="mt-10 mr-10 pr-10 lg:mt-16 xl:max-w-2xl">
      ...
      <div class="hidden lg:flex items-center justify-center bg-indigo-100 flex-1 rounded">
